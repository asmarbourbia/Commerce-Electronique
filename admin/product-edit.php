...
Nom de la catégorie de niveau supérieur<span>*</span></label>
							<div class="col-sm-4">
								<select name="tcat_id" class="form-control select2 top-cat">
		                            <option value="">
Sélectionnez la catégorie de niveau supérieur</option>
		                            <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
		                            <option value="">
Sélectionner une catégorie de niveau finalSélectionner une catégorie de niveau final</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Nom produit <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_name" class="form-control" value="<?php echo $p_name; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Oncien prix<br><span style="font-size:10px;font-weight:normal;">(In DH)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Selectinnez de taille</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Selectionnez  Couleur</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Photo en vedette existante</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Changer la photo en vedette </label>
							<div class="col-sm-4" style="padding-top:4px;">
