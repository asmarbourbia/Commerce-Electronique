...
<section class="content-header">
	<div class="content-header-left">
		<h1>
Modifier les frais d'expédition</h1>
	</div>
	<div class="content-header-right">
		<a href="shipping-cost.php" class="btn btn-primary btn-sm">Voir tout</a>
	</div>
</section>
            ...
            <div class="box box-info">
                <div class="box-body">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Selectionnez un pays <span>*</span></label>
                        <div class="col-sm-4">
