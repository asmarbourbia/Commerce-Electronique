						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td> <?php echo $row['p_old_price']; ?>DH</td>
									<td> <?php echo $row['p_current_price']; ?>DH</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Sois prudent! Ce produit sera également supprimé du tableau des commandes, du tableau des paiements, du tableau des tailles, du tableau des couleurs et du tableau des évaluations.</p>
            </div>
