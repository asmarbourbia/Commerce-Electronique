...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Les slides ont été mises à jour avec succès !';
	}
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Voir tout</a>
	</div>
</section>
...
Photo existante</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(Seulement jpg, jpeg, gif et png sont autorisées)
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Button Texte </label>
							<div class="col-sm-6">
