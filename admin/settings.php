        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Icône </a></li>
                        <li><a href="#tab_3" data-toggle="tab">Footer & Contact</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Paramètres des messages</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Produits</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Paramètres d'accueil</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Paramètres de la bannière</a></li>
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Nouveau Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Modifier Logo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Mettre à jour l'icône de favori</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
Section Bulletin </label>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"> Email Contact </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="contact_email" value="<?php echo $contact_email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">numéro de téléphone de contact</label>
                                        <div class="col-sm-6">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contacter la carte iFrame </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Objet de l'e-mail de contact</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="receive_email_subject" value="<?php echo $receive_email_subject; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact E-mail Message de remerciement</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-success pull-left" name="form4">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (Combien de produits présentés ?)<span>*</span></label>
                                        <div class="col-sm-2">
...
Page d'accueil (Combien de derniers produits ?)<span>*</span></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">
Page d'accueil (Combien de produits populaires ?)<span>*</span></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form5">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>
Sections activées et désactivées</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section d'accueil</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des produits en vedette </label>
                                        <div class="col-sm-4">
...
Dernière section de produits </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">
Section de produits populaires </label>
                                        <div class="col-sm-4">
                                   ...
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_0">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta-mot-de-clé </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6">modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Section des produits en vedette</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">
Titre du produit en vedette<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">
Sous-titre du produit en vedette<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_4">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Dernière section de produits</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du dernier produit<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre du dernier produit<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_5">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>
Section de produits populaires</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre du produit populaire<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">
Sous-titre du produit populaire<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_6">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3> Section de bulletin</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">
Texte du bulletin d'information</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_3">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page de connexion</h4>
                                        Selectionnez Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page d'inscription</h4>
                                        Selectionnez Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de page de mot de passe oublié existante</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page Mot de passe oublié</h4>
                                        Selectionnez Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de la page de réinitialisation du mot de passe existante</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page de réinitialisation du mot de passe</h4>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de page de recherche existante</h4>
                                        <p>
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de page de panier existante</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page du panier</h4>
                                        Selectionnez Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de page de paiement existante</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page de paiement</h4>
                                        Selectionnez Photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Bannière de page de catégorie de produit existante</h4>
                                        <p>
                                    ...
                                    <td style="width:50%">
                                        <h4>
Modifier la bannière de la page de catégorie de produit</h4>
                                        Selectionnez Photo<input type="file" name="photo">
...
Information bancaire </label>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form9">MODIFIER</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form10">Modifier</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
