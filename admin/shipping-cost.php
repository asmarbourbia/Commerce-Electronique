...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= 'Vous devez obligatoirement sélectionner un ville.<br>';
    }
    ...
    if($_POST['amount'] == '') {
        ...
        if(!is_numeric($_POST['amount'])) {
            $valid = 0;
            $error_message .= 'Vous devez obligatoirement saisir un numéro valide.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les frais d expédition sont ajoutés avec succès.';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les frais de livraison pour le reste du monde ont été mis à jour avec succès.';
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Ajouter les frais de livraison</h1>
    </div>
</section>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Selectionnez un vile <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>
Voir les frais de livraison</h1>
	</div>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="shipping-cost-edit.php?id=<?php echo $row['shipping_cost_id']; ?>" class="btn btn-primary btn-xs">Editer</a>
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB : Si un ville n'existe pas dans la liste ci-dessus, les frais de port "Reste du Monde" suivants lui seront appliqués</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Frais d'expédition (reste du monde)</h1>
    </div>
</section>
