...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "Le nom du ville ne peut pas être vide<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Le nom de la ville existe déjà<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La ville est mis à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="country.php" class="btn btn-primary btn-sm">Voir tout</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nom de la ville <span>*</span></label>
                    <div class="col-sm-4">
