...
if(isset($_POST['form1'])) {
	...
	$success_message = 'Les paramètres de langue sont mis à jour avec succès.';
}
    ...
    <div class="col-md-12">
		...
		<div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Modifier <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[5]" value="<?php echo $lang_ids[5]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">En savoir plus <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <h3 style="font-size:20px;font-weight:500;">Se connecter</h3>
		<div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Se connecter <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Cliquez ici pour vous identifier <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Se deconnecter<span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Inscription réussite <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Panier <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mise à jour panier<span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">la caisse <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Veuillez vous connecter en tant que client pour procéder au paiement
 <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Historique de commande <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Date et heure de paiement <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[27]" value="<?php echo $lang_ids[27]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">identifiant de transaction<span>*</span></label>
                    <div class="col-sm-6">
...
Montant payé <span>*</span></label>
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Statut de paiement <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Mode de paiement <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[31]" value="<?php echo $lang_ids[31]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Identifiant de paiement<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[32]" value="<?php echo $lang_ids[32]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Section Paiement <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Bande<span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Dépôt bancaire <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Numéro de carte <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Envoyer à ce Détails <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Informations sur les transactions <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[44]" value="<?php echo $lang_ids[44]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Inclure correctement l'identifiant de la transaction et d'autres informations <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[45]" value="<?php echo $lang_ids[45]; ?>">
                    </div>
                </div>				
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Payez maintenant <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">				
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Nom de produit <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
détails du produit <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Produits connexes <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[155]" value="<?php echo $lang_ids[155]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Voir tous les produits connexes ci-dessous <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Categorie: <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Sélectionnez coleur <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Partagez ceci <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Revoir <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Poster le commentaire <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">La note a été soumise avec succès ! <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Notation <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Frais de port <span>*</span></label>
                    <div class="col-sm-6">
...
S'abonner <span>*</span></label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Abonnez-vous à notre newsletter <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;"> Addresse Email</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Addresse Email  <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[94]" value="<?php echo $lang_ids[94]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Entrez votre adresse email <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Mot de passe oublié <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Retaper le mot de passe<span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Mettre à jour le mot de passe <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">
nouveau mot de passe<span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[100]" value="<?php echo $lang_ids[100]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Re-taper le nouveau mot de passe <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Nom et prénom <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Nom de l'entreprise <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Addresse <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">les autres informations</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Postes en vedette <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Messages récents <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Modifier Profile <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[117]" value="<?php echo $lang_ids[117]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Envoyer le message <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <h3 style="font-size:20px;font-weight:500;">Messages Erreur </h3>
        <div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Félicitation ! Le paiement est réussi. <span>*</span></label>
                    <div class="col-sm-6">
...
L'adresse ne peut pas être vide. <span>*</span></label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Vous devez obligatoirement sélectionner un pays.<span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Les informations de profil sont mises à jour avec succès. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
L'adresse e-mail ne peut pas être vide <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
L'adresse de messagerie ne correspond pas. <span>*</span></label>
                    <div class="col-sm-6">
...
L'adresse e-mail doit être valide. <span>*</span></label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Votre adresse e-mail n'est pas trouvée dans notre système. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Veuillez vérifier votre courrier électronique et confirmer votre abonnement.<span>*</span></label>
                    <div class="col-sm-6">
...
Votre email est vérifié avec succès. Vous pouvez maintenant vous connecter à notre site Web. <span>*</span></label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Le mot de passe ne peut pas être vide. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Veuillez saisir un nouveau mot de passe et retaper. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[140]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[140]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Le mot de passe est mis à jour avec succès. <span>*</span></label>
                    <div class="col-sm-6">
...
Pour réinitialiser votre mot de passe, veuillez cliquer sur le lien ci-dessous. <span>*</span></label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
DEMANDE DE RÉINITIALISATION DU MOT DE PASSE - VOTRE SITE WEB.COM <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Le délai d'envoi de l'e-mail de réinitialisation du mot de passe (24 heures) a expiré. Veuillez réessayer de réinitialiser votre mot de passe. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Un lien de confirmation est envoyé à votre adresse e-mail. Vous y obtiendrez les informations de réinitialisation du mot de passe. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[145]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[145]; ?></textarea>
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Le mot de passe est réinitialisé avec succès. Vous pouvez maintenant vous connecter. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">
Désolé! Votre compte est inactif. Veuillez contacter l'administrateur. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[148]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[148]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Confirmation par e-mail d'inscription pour VOTRE SITE WEB. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group"> 
                    <label for="" class="col-sm-4 control-label">
Votre inscription est terminée. Veuillez vérifier votre adresse e-mail pour suivre le processus de confirmation de votre inscription.<span>*</span></label>
                    <div class="col-sm-6">
