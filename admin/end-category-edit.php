...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "Le nom de la catégorie de niveau final ne peut pas être vide<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La catégorie de niveau final a été mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier la catégorie du niveau final</h1>
	</div>
