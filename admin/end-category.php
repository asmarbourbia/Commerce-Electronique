...
<section class="content-header">
	<div class="content-header-left">
		<h1>Afficher les catégories de niveau final</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category-add.php" class="btn btn-primary btn-sm">Ajouter un nouveau</a>
	</div>
</section>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
			<thead>
			    <tr>
			        <th>#</th>
			        <th>Nom de la catégorie de niveau final</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Sois prudent! Tous les produits de cette catégorie finale seront supprimés de tous les tableaux comme le tableau des commandes, le tableau des paiements, le tableau des tailles, le tableau des couleurs, le tableau des notes, etc.</p>
            </div>
