...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "Le nom du vill ne peut pas être vide<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Le nom du ville existe déjà<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Le ville a été ajouté avec succès.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nom du ville <span>*</span></label>
							<div class="col-sm-4">
