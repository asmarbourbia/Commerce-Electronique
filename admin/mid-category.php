...
<section class="content-header">
	<div class="content-header-left">
		<h1>
Voir les catégories de niveau intermédiaire</h1>
	</div>
          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
			<thead>
			    <tr>
			        <th>#</th>
			        <th>
Nom de la catégorie de niveau intermédiaire</th>
                    <th>
Nom de la catégorie de niveau supérieur</th>
			        <th>Action</th>
			    </tr>
			</thead>
            <tbody>
...
Confirmation de suppression</h4>
            ...
            <div class="modal-body">
                <p>
Etes-vous sûr de vouloir supprimer cet élément ?</p>
                <p style="color:red;">Sois prudent! Tous les produits et catégories de niveau final de cette catégorie de niveau intermédiaire seront supprimés de tous les tableaux comme le tableau des commandes, le tableau des paiements, le tableau des tailles, le tableau des couleurs, le tableau des notes, etc.</p>
            </div>
