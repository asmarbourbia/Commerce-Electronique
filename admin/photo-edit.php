...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['caption'])) {
        $valid = 0;
        $error_message .= "Le nom de la légende de la photo ne peut pas être vide<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'La photo est mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Voir tout</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Légende des photos <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Télécharger une nouvelle photo <span>*</span></label>
