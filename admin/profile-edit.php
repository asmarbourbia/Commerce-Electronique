		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab_1" data-toggle="tab">Modifier Information</a></li>
						<li><a href="#tab_2" data-toggle="tab">Modifier Photo</a></li>
						<li><a href="#tab_3" data-toggle="tab">Modifier Password</a></li>
					</ul>
          				...
          				<div class="tab-pane active" id="tab_1">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"> Addresse Email <span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form1">Modifier Information</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="box box-info">
								<div class="box-body">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form2">Modifier Photo</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="box box-info">
								<div class="box-body">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Modifier le mot de passe </button>
										</div>
									</div>
								</div>
							</div>
