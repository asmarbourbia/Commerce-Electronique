...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Désolé! Il y a seulement'.$current_p_qty.' article(s) en stock';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Ce produit est déjà ajouté au panier.';
            ...
            $success_message1 = 'Le produit a été ajouté au panier avec succès !';
        }
...
// Assurez-vous que $row est correctement initialisé avec les données du produit
$row['p_id'] = isset($row['p_id']) ? $row['p_id'] : null;
...
?>
                            ...
                            <div class="p-quantity">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb_20">
                                        <?php echo "Sélectionnez la taille"; ?> <br>
                                    ...
                                    <?php if(isset($color)): ?>
                                    <div class="col-md-12">
                                        <?php echo "Sélectionnez la couleur"; ?> <br>
							...
							<div class="p-price">
                                <span style="font-size:14px;"><?php echo"Prix ​​du produit"; ?></span><br>
                                <span>
                                    <?php if($p_old_price!=''): ?>
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="<?php echo "ajouter au panier"; ?>" name="form_add_to_cart">
							</div>
                            </form>
							<div class="share">
                                <?php echo "Partager ce produit"; ?> <br>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#description" aria-controls="description" role="tab" data-toggle="tab"><?php echo "Description du produit"; ?></a></li>
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab"><?php echo "Caractéristiques"; ?></a></li>
                                <li role="presentation"><a href="#condition" aria-controls="condition" role="tab" data-toggle="tab"><?php echo "Conditions"; ?></a></li>
                                <li role="presentation"><a href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="tab"><?php echo "Politique de retour"; ?></a></li>
                                <li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab"><?php echo "Avis"; ?></a></li>
							</ul>
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        $total = $statement->rowCount();
                                        ?>
                                        <h2><?php echo "Avis"; ?> (<?php echo $total; ?>)</h2>
                                        <?php
                                        if($total) {
                                            $j=0;
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result as $row) {
                                                $j++;
                                                ?>
                                                <div class="mb_10"><b><u><?php echo "avis"; ?> <?php echo $j; ?></u></b></div>
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <th style="width:170px;"><?php echo "Nom du client"; ?></th>
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <input type="submit" class="btn btn-default" name="form_review" value="<?php echo "Soumettre Avis"; ?>">
                                            </form>
                                            <?php else: ?>
                                                <span style="color:red;"><?php echo "Vous avez déjà donné une avis!"; ?></span>
                                            <?php endif; ?>


                                        <?php else: ?>
                                            <p class="error">
												<?php echo "Vous devez vous connecter pour donner un avis"; ?> <br>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php echo "PRODUITS SIMILAIRES"; ?></h2>
                    <h3><?php echo "Voir tous les produits similaire ci-dessous"; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    ?>
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo "ajouter au panier"; ?></a></p>
                            </div>
                        </div>
                        <?php
                    }
