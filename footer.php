                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            try {
                                ...
                                $mail->addAddress($_POST['email_subscribe']); // Adresse e-mail de l'administrateur
                               
                                $mail->isHTML(true);
                                $mail->Subject = " Confirmation par e-mail de l'abonné ";
                                $to = $_POST['email_subscribe'];
                                $verification_url ='http://localhost/e_v1/eCommerceSite-PHP/verify.php?email='.$to.'&key='.$key;
                                $message = 'Merci de votre intérêt pour votre inscription à notre newsletter!<br><br>
                                Veuillez cliquer sur ce lien pour confirmer votre abonnement:'.$verification_url.'<br><br>
...
<script>
	...
	{
	    return confirm("Êtes-vous sûr de vouloir supprimer ces données ?");
	}
