...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    {   
        ...
        $success_message = '<p style="color:green;">Votre email est vérifié avec succès. Vous pouvez maintenant vous connecter à notre site Web.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Cliquez ici pour vous identifier</a></p>';     
    }
}
?>
