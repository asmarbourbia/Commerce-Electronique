...
if (isset($_POST['form1'])) {
    ...
    $_SESSION['customer']['cust_b_cname'] = strip_tags('1');
    ...
    $_SESSION['customer']['cust_b_city'] = strip_tags('1');
    $_SESSION['customer']['cust_b_state'] = strip_tags('1');
    $_SESSION['customer']['cust_b_zip'] = strip_tags($_POST['cust_b_zip']);
    $_SESSION['customer']['cust_s_name'] = strip_tags($_POST['cust_s_name']);
    $_SESSION['customer']['cust_s_cname'] = strip_tags('1');
    ...
    $_SESSION['customer']['cust_s_city'] = strip_tags('1');
    $_SESSION['customer']['cust_s_state'] = strip_tags('1');
