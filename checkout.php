                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo $shipping_cost; ?> <?php echo LANG_VALUE_1; ?></td>
                        </tr>
                        <tr>
                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Vous devez remplir toutes les informations de facturation et d'expédition à partir de votre panneau de tableau de bord afin de valider la commande. Veuillez remplir les informations en allant à<a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">ce lien</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="PayPal"><?php echo "paiement en ligne"; ?></option>
	                                        <option value="Bank Deposit"><?php echo "paiement à livraison"; ?></option>
	                                    </select>
	                                </div>

                                    <form class="paypal" action="http://localhost/e_v1/eCommerceSite-PHP/payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                           <!-- <label for=""><?/*php echo LANG_VALUE_44; */?> <br><span style="font-size:12px;font-weight:normal;">-->
